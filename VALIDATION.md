...
consistency, correction identity, stale governed fields, exclusive entry
branches, stage/debrief/results/closeout boundaries, and the one-page proof
contract. The mutation suite
runs in disposable copies and proves that the declared forbidden states are
rejected, including debrief-before-scoring and checksum-refreshed closure
defects. These are repository-integrity checks only. They do not establish
