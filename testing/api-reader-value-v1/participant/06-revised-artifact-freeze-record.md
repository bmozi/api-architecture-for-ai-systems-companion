...
- Completed record exact local filename: `API-A-REVISED-FREEZE-RECORD-v1.md`
...
The governing manifest hashes only the two revised detail files below. It does
...
| --- | --- | --- | --- | --- | --- | --- |
| `API-A-REVISED-WORKBOOK-v1.md` | | | `REVISED COMPLETE` | | yes / no | `FROZEN` / not established |
| `API-A-REVISED-CAPABILITY-BRIEF-v1.md` | | | `REVISED COMPLETE` | | yes / no | `FROZEN` / not established |
...
- No incomplete-state marker or premature self-declared `FROZEN` remains:
  yes / no
- This record establishes `FROZEN` for both verified hashes: yes / no
