...
The governing manifest hashes only the two completed revised artifacts below.
...
| --- | --- | --- | --- | --- | --- |
| `API-A-REVISED-WORKBOOK-v1.md` | | | `REVISED COMPLETE` | | yes / no |
| `API-A-REVISED-CAPABILITY-BRIEF-v1.md` | | | `REVISED COMPLETE` | | yes / no |
