...
6. Open `api-event-workflow-decision-tree.md` and revise the detailed artifact
   if needed.
7. Complete workbook Sections 2-4. Freeze the initial workbook and capability
   brief under immutable filenames with IDs, versions, timestamps/timezones,
   hashes, and a detached manifest.
...
10. Create `API-A-REVISED-ARTIFACTS-SHA256SUMS-v1.txt`, hashing those two
    ...
    `API-A-REVISED-FREEZE-RECORD-v1.md` with exact freeze timestamp/timezone,
...
11. Only after that detached record verifies, open the blank
    `05-one-screen-handoff.md`. List those same literal revised filenames and
    complete it as `API-A-ONE-SCREEN-HANDOFF-v1.md`. Freeze it separately.
...
1. Open this route, then `API-A-ONE-SCREEN-HANDOFF-v1.md` as the first
   substantive artifact.
2. Open `04-decision-owner-workbook.md`, complete Section 1 from the handoff
   alone, export it as `API-B-SECTION-1-SCAN-v1.md`, and checksum-freeze it.
3. Open `02-scenario-and-task.md`,
   `API-A-REVISED-FREEZE-RECORD-v1.md`, and
...
5. Complete Section 2, export it as `API-B-SECTION-2-DETAIL-v1.md`, and
